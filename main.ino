...
float soilThresholdValue = 25.0;                     // 30% water content
...
float calibrationSlope = 1.6512113655911938;         // pH calibration slope
...
void MainFunction() {
  ...
  if (rainSensorValue > rainThresholdValue) {
    ...
    digitalWrite(WATER_PUMP_PIN, HIGH);  // Turn off the water pump
    return;
  }
